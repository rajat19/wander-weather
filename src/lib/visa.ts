...
// ISO2 to ISO3 mapping for countries (fallback when Firebase data doesn't have alpha3)
export const ISO2_TO_ISO3: Record<string, string> = {
  DZ: 'DZA', AL: 'ALB', AD: 'AND', AO: 'AGO', AG: 'ATG', AR: 'ARG', AM: 'ARM',
  AU: 'AUS', AT: 'AUT', AZ: 'AZE', BS: 'BHS', BH: 'BHR', BD: 'BGD', BB: 'BBD',
  ...
  JO: 'JOR', KZ: 'KAZ', KE: 'KEN', KI: 'KIR', KP: 'PRK', KR: 'KOR', XK: 'XKX',
